...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"Dia/Mês/Ano --> " + Colors.YELLOW_UNDERLINED + dft.format(LocalDateTime.now()) + Colors.RESET);
		...
		System.out.println(
				"Hora:Min:Seg --> " + Colors.YELLOW_UNDERLINED + hrt.format(LocalDateTime.now()) + Colors.RESET);
