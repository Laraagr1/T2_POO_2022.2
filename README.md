...
|[02](https://github.com/Laraagr1/T2_POO_2022.2/tree/main/02%20-%20Op%C3%A7%C3%B5es)|This code shows a menu of options, where the user has the option of adding two numbers or taking the square root of a number, and shows the result of the operation.|
...
|[08][https://github.com/Laraagr1/T2_POO_2022.2/tree/main/08%20-%20Salary]|Program that shows a menu of options, allows the user to choose the desired option, receives the necessary data and executes and shows the result of the operation made based on his salary.|
