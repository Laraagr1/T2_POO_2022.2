...
|[07](https://github.com/Laraagr1/T2_POO_2022.2/blob/main/issuedoentdid/issuedosentdid.md)|Program that receives the age, weight and height of each of the players of 5 soccer teams and shows the number of players under the age of 18, the average age of the players of each team, the average height of all those of the championship and a player of players with more than 80 kg among the players of the championship.|
