...
public class Utils {
	...
	public void Calcdelta() {
		...
		if (delta >= 0) {
			...
			System.out.format(Colors.YELLOW + "\nThe value of x1 is: " + Colors.RESET + Colors.PURPLE_UNDERLINED
					+ "%.2f" + Colors.RESET, x1);
			System.out.format(Colors.YELLOW + "\nThe value of x2 is: " + Colors.RESET + Colors.PURPLE_UNDERLINED
					+ "%.2f" + Colors.RESET, x2);
			System.out.format(Colors.YELLOW + "\nThe value of delta is :" + Colors.RESET + Colors.PURPLE_UNDERLINED
					+ "%.2f\n" + Colors.RESET, delta);
		} else {
			System.out.println(Colors.RED_BOLD + "\nThis equation has no real roots\nBecause the delta is negative"
					+ Colors.RESET);
		}
	}
